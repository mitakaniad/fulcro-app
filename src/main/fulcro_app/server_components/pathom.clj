(ns fulcro-app.server-components.pathom
  (:require
   ...
   [clojure.core.async :as async]
    ...
    ;; Central registry
   [fulcro-app.server-components.pathom-wrappers :refer [pathom-registry]]
   [fulcro-app.server-components.config :refer [config]]
   
    ;; ALL namespaces that use pathom-wrappers MUST be included for auto-registration to work
   fulcro-app.model.user
   fulcro-app.api.read
   fulcro-app.api.mutations
   ))
